...
class KeywordExtractor:
    ...
    def extract_keywords(self, text: str, num_keywords: int = 10, min_ngram: int = 1, max_ngram: int = 2) -> List[str]:
        """
    ...
    def _tfidf_keywords(self, text: str, num_keywords: int, min_ngram: int, max_ngram: int) -> List[str]:
        """
